...
import { AxiosCommon, AxiosSourceCancelConfig, AxiosResponseConfig } from 'src/types';
...
class HttpClient {
  ...
  constructor(commonOption: AxiosCommon, options: AxiosCommon) {
  ...
  // 回包成功回调
  responseSuccessHandle = (response: AxiosResponseConfig<never>) => {
    let msg = '未知错误';
    ...
    console.error(response.data.msg || msg);
